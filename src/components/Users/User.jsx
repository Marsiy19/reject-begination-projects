...
export const User = ({id, email, first_name, last_name, avatar, onClickInvated, IsInvated}) => (
  <li>
    <div>
    ...
    <i onClick={() => onClickInvated(id)} className={`bx bx-${IsInvated ? 'minus' : 'plus'} text-2xl hover:text-gray-600 text-gray-400 cursor-pointer`}></i>
  </li>
);
